    ...
    <div className="single-product-main-content">
      <div className="layout">
        <div className="single-product-page">
          <div className="left">
            <img
              src={"http://127.0.0.1:8000/storage/" + singleProduct[0]?.image_url}
              alt="product"
            />
          </div>
          <div className="right">
            ...
            {singleProduct[0]?.quantity >= 1 ? (
                <span className="inStock"><TbCircleFilled/> in stock</span>
              ) : (
                <span className="outStock"><TbCircleFilled/> out of stock</span>
              )}
            <span className="desc">{singleProduct[0]?.description}</span>
            <span className="delivery">Delivery time: <span className="days">1-3 days</span> </span>
